...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 <!-- Required for utility-fn.xsl -->
  ...
  <!-- TODO: Update with the metadata element -->
  ...
  <!-- TODO: Enable/customise if required -->
  ...
  <!-- TODO: Update with the metadata element used for the title -->
  ...
  <!-- TODO: Update with the metadata element used for the abstract -->
  ...
  <!-- TODO: Update with the metadata element used for the hierarchy level -->
  ...
  <!-- TODO: Update with the metadata element used for the thumbnail -->
  ...
  <!-- TODO: Update with the metadata element used for overviews (thumbnails) -->
  ...
  <!-- TODO: Update with the metadata elements used for the header -->
